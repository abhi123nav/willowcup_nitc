...
<body>
	...
	<section class="message ">
		<div class="container text-center alert alert-danger" role="alert">
			<h1 style="color: black;">Comitte Members</h1>
</div>
			<br /> <br />
...
<div class="container text-center">
			...
			<div class="text-center">
				...
				<figure style="padding: 10px;">
					<img src="<c:url value="/resources/images/photo.jpg"/>"
						alt="abhinavsingh" class="
			rounded" height="300px" width="300">
					<figcaption>Abhinav singh</figcaption>
				</figure>


			</div>
			<!-- end of website maker -->
